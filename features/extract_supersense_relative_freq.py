...
parser.add_argument("--relative_freq_filename", default="/usr1/home/ytsvetko/projects/curric/data/wordnet/supersense_relative_freqs.txt")
args = parser.parse_args()

FEATURE_NAME = "supersense_relative_freq"
